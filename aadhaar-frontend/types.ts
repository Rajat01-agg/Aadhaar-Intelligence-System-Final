...
// NEW: Filter Types based on Phase-1 Lite
export type SignalType = 'Anomalies' | 'Trends' | 'Patterns' | 'Accessibility Gap' | 'Operational Stress';
export type SeverityLevel = 'All' | 'Critical' | 'High' | 'Medium';
export type TimeWindow = 'Last 24h' | 'Last 7 days' | 'Last 30 days';
...
export interface AppliedFilters {
  ...
  // New Filters
  signalTypes?: SignalType[]; // Multi-select
