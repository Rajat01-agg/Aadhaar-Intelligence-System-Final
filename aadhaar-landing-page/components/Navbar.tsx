        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 pl-4 border-l border-gray-200">
              ...
              <button className="bg-govt-blue text-white px-4 py-2 rounded text-sm font-medium hover:bg-blue-800 transition-colors shadow-sm">
                Official Login
              </button>
            </div>
          </div>
        ...
        <div className="lg:hidden bg-gray-50 border-t border-gray-200">
          <nav className="flex flex-col px-4 py-4 space-y-2">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <button className="w-full bg-govt-blue text-white px-4 py-2 rounded font-medium hover:bg-blue-800 transition-colors">
                Official Login
              </button>
            </div>
          </nav>
